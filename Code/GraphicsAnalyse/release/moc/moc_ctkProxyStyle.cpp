...
#include <memory>
#include "../../CTK/Libs/Widgets/ctkProxyStyle.h"
...
void ctkProxyStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkProxyStyle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkProxyStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QProxyStyle::staticMetaObject>(),
    qt_meta_stringdata_ctkProxyStyle.data,
    qt_meta_data_ctkProxyStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
