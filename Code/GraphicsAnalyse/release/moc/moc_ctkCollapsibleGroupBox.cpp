...
#include <memory>
#include "../../CTK/Libs/Widgets/ctkCollapsibleGroupBox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkCollapsibleGroupBox_t, stringdata0) + ofs \
...
void ctkCollapsibleGroupBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkCollapsibleGroupBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 1: *reinterpret_cast< int*>(_v) = _t->collapsedHeight(); break;
        default: break;
        }
        ...
        case 1: _t->setCollapsedHeight(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkCollapsibleGroupBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QGroupBox::staticMetaObject>(),
    qt_meta_stringdata_ctkCollapsibleGroupBox.data,
    qt_meta_data_ctkCollapsibleGroupBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkCollapsibleGroupBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkCollapsibleGroupBox.stringdata0))
