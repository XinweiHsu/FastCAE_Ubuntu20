...
#include <memory>
#include "../../CTK/Libs/Widgets/ctkExpandButton.h"
...
void ctkExpandButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkExpandButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkExpandButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QToolButton::staticMetaObject>(),
    qt_meta_stringdata_ctkExpandButton.data,
    qt_meta_data_ctkExpandButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
