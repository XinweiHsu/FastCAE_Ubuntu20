...
#include <memory>
#include "../../CTK/Libs/Widgets/ctkDoubleSpinBox_p.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkQDoubleSpinBox_t, stringdata0) + ofs \
...
void ctkQDoubleSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ctkQDoubleSpinBox *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->invertedControls(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setInvertedControls(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkQDoubleSpinBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QDoubleSpinBox::staticMetaObject>(),
    qt_meta_stringdata_ctkQDoubleSpinBox.data,
    qt_meta_data_ctkQDoubleSpinBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkQDoubleSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkQDoubleSpinBox.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ctkDoubleSpinBoxPrivate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void ctkDoubleSpinBoxPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkDoubleSpinBoxPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkDoubleSpinBoxPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ctkDoubleSpinBoxPrivate.data,
    qt_meta_data_ctkDoubleSpinBoxPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ctkDoubleSpinBoxPrivate.stringdata0))
        return static_cast<void*>(this);
