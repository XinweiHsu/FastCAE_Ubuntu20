...
QT_MOC_LITERAL(5, 50, 16), // "sig_add_dropItem"
QT_MOC_LITERAL(6, 67, 21) // "sig_mouse_rightButton"

    },
    "DropTreeWidget\0changed\0\0const QMimeData*\0"
    "mimeData\0sig_add_dropItem\0"
...
void DropTreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DropTreeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DropTreeWidget::*)(const QMimeData * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DropTreeWidget::changed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DropTreeWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DropTreeWidget::sig_add_dropItem)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DropTreeWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DropTreeWidget::sig_mouse_rightButton)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DropTreeWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QTreeWidget::staticMetaObject>(),
    qt_meta_stringdata_DropTreeWidget.data,
    qt_meta_data_DropTreeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void DropTreeWidget::changed(const QMimeData * _t1)
{
...
// SIGNAL 2
void DropTreeWidget::sig_add_dropItem(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void DropTreeWidget::sig_mouse_rightButton()
{
