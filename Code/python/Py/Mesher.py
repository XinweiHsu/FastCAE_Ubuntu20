...
#    self.physicalsList = list()
  ...
  def appendSolidsFields(self,tp,vi,vo,tn,setid,index,bg):
    solidsList = [tp,vi,vo,tn,setid,index,bg]
    self.fieldsList.append(solidsList)
    
  def appendFrustumFields(self,tp,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,bg):
    frustumlist = [tp,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,bg]
